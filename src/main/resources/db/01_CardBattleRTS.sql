...
ALTER TABLE `Card_Product` ADD CONSTRAINT `Card_Product_fk4` FOREIGN KEY (`p1_set_resource_id`) REFERENCES `Card_Resource`(`id`);
ALTER TABLE `Card_Product` ADD CONSTRAINT `Card_Product_fk5` FOREIGN KEY (`p2_set_resource_id`) REFERENCES `Card_Resource`(`id`);
ALTER TABLE `Card_Product` ADD CONSTRAINT `Card_Product_fk6` FOREIGN KEY (`p1_set_upgrade_id`) REFERENCES `Card_Upgrade`(`id`);
ALTER TABLE `Card_Product` ADD CONSTRAINT `Card_Product_fk7` FOREIGN KEY (`p2_set_upgrade_id`) REFERENCES `Card_Upgrade`(`id`);
